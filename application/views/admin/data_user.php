...
<div id="content">
<p>
	<a href="<?php echo base_url()."index.php/Admin/Admin/input_buku";?>"" class="btn btn-mini"><i class="icon-plus"></i> Menambah Data Mahasiswa</a>
	<a href="<?php echo base_url()."index.php/Admin/Admin/print_mhs";?>"" class="btn btn-mini"><i class="icon-plus"></i> Print Data Mahasiswa</a>
	<div align = "right">
	<div align = "right">
	<?php echo form_open("Admin/Admin/cari_user");?>
		<input type="text" name="cari_user" placeholder="Cari berdasarkan Nama Mahasiswa">
...
<table class="table table-bordered table-condensed table-hover">
	...
	<?php 
	$no = $tot+1;
	foreach ($data_user->result_array() as $d) {?>
	<tbody>
		<tr class="nowrap">
			...
			<?php if($_SESSION['level']=='admin'){?>
			<td><a href="<?php echo base_url()."index.php/Admin/Admin/edit_buku/".$d['username'];?>" class="btn btn-mini"><i class="icon-edit"></i> Edit</a>
			<td><a href="<?php echo base_url()."index.php/Admin/Admin/hapus_buku/".$d['username'];?>" class="btn btn-mini" 
			onClick="return confirm('Apakah anda ingin menghapus data buku dengan judul : <?php echo $d['username'];?>');"><i class="icon-trash"></i> Delete</a></td>
			<?php } ?>
		</tr>
<?php
	}
...
<div>
	<div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink">
		...
		<center><h5>Data Fakultas Mahasiswa Chart</h5></center>
...
type: 'bar',
data: {
	labels: ['Fakultas Ilmu Komputer','Fakultas Teknik','Fakultas Hukum','Fakultas Agama Islam'],
	datasets:[{
		label :'#of votes',
		data:[3,2,1,1

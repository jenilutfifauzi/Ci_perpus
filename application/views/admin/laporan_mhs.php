...
<body>
    ...
    <button onclick="print_d()">Print Export Pdf</button>
        <script>
        function print_d(){
            window.open("pdf_mhs","_blank");
        }
        </script>
        <a href="<?php echo base_url()."index.php/Admin/Admin/excel_mhs"; ?>"><input type="button" value="Print Export Ms Excel" /></a>
        <a href="<?php echo base_url()."index.php/Admin/Admin/data_user"; ?>"><input type="button" value="Kembali" /></a>
    </div>
    <br>

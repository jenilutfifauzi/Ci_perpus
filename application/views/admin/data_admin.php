...
<div id="content">
<p>
	<a href="<?php echo base_url()."index.php/Admin/Admin/input_buku";?>"" class="btn btn-mini"><i class="icon-plus"></i> Menambah Data Admin</a>
	<a href="<?php echo base_url()."index.php/Admin/Admin/print_admin";?>"" class="btn btn-mini"><i class="icon-plus"></i> Print Data Admin</a>
	<div align = "right">
	<?php echo form_open("Admin/Admin/cari_user");?>
		<input type="text" name="cari_user" placeholder="Cari berdasarkan Nama Admin">
...
<div>
	<div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink">
		...
		<center><h5>Data Tempat Lahir Admin Chart</h5></center>

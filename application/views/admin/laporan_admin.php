...
<body>
    ...
    <button onclick="print_d()">Print Export Pdf</button>
        <script>
        function print_d(){
            window.open("pdf_admin","_blank");
        }
        </script>
        <a href="<?php echo base_url()."index.php/Admin/Admin/excel_admin"; ?>"><input type="button" value="Print Export Ms Excel" /></a>
        <a href="<?php echo base_url()."index.php/Admin/Admin/data_admin"; ?>"><input type="button" value="Kembali" /></a>
    </div>
    <br>
    <table border="1" style="border-collapse:collapse;">
        ...
        <?php 
            $no = +1;
            foreach($data_admin->result_array() as $dp)
            {
        ?>
            <tr>
